        ...
        <div className='container'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 13+ crore customers trust Zerodha with 35+ lakh crores wordth of equity investments.</p>
                    <h2 className='fs-4'>No spam or gimmicks</h2>
                    <p className='text-muted'>No gimmicks, spam, "gimmification", or annoying push notifications. High quality apps that you use at your pace, the way you like.</p>
